...
def get_tuples():
    ...
    x1 = numpy.arange (6.0, 7.0, 1.0)
    y1 = numpy.arange (3.0, 11.5, 1.0)
    p1 = itertools.product (x1,y1)
    l1 = list(p1)

    x2 = numpy.arange (12.0, 13.0, 1.0)
    y2 = numpy.arange (6.0, 14.5, 1.0)
    p2 = itertools.product (x2,y2)
    l2 = list(p2)

    x3 = numpy.arange (18.0, 19.0, 1.0)
    y3 = numpy.arange (7.0, 15.5, 1.0)
    p3 = itertools.product (x3,y3)
    l3 = list(p3)

    x4 = numpy.arange (24.0, 25.0, 1.0)
    y4 = numpy.arange (6.5, 15.0, 1.0)
    p4 = itertools.product (x4,y4)
    l4 = list(p4)

    x5 = numpy.arange (30.0, 31.0, 1.0)
    y5 = numpy.arange (4.0, 12.5, 1.0)
