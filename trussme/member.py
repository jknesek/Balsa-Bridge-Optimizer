...
class Member(object):
    ...
    def __init__(self, joint_a, joint_b):
        ...
        self.Cy = 0.0       # compression strength
    ...
    def set_material(self, new_material, update_props=True):
        ...
        self.Cy = materials[new_material]["Cy"]
    ...
    def set_force(self, the_force):
        ...
        if self.force < 0:
#            self.fos_yielding = self.Cy/abs(self.force/self.area)
            self.fos_yielding = -self.Cy*self.area
        else:
#            self.fos_yielding = self.Fy/abs(self.force/self.area)
            self.fos_yielding = self.Fy*self.area
