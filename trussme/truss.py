...
class Truss(object):
    ...
    def __init__(self, file_name=""):
        ...
        #The condition number is high, so the results may be inaccurate.
        self.result_suspect = False
    ...
    def result_is_suspect(self):
        return result_suspect
